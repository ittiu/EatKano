...
(function(w) {
    ...
    function shareText(score) {
        ...
        if (score <= 49) return '你不行啊！';
        if (score <= 99) return '菜';
        if (score <= 149) return '咱班还是有能人嘞';
        if (score <= 199) return '高手';
        return '人？';
    }
    ...
    function initSetting() {
        ...
        document.getElementsByTagName("title")[0].innerText = cookie("title") ? cookie("title") : "吃掉裴志昂";
        if (cookie("keyboard")) {
